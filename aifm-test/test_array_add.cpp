...
void do_work(FarMemManager *manager) {
  ...
  for (uint64_t i = 0; i <= 10; i++) {
    DerefScope scope;
    auto temp_out = array_A.at(scope, i); //see the value stored in remote mem
    cout<< temp_out << endl;
  }
...
// void do_work_test(FarMemManager *manager) {
//   cout << "Running " << __FILE__ "..." << endl;

//   //int iterations = 10;
//   auto test_Array_A = manager->allocate_array<uint64_t, kNumEntries>();
